    ...
    $(document).keydown((e) => {
        if (e.key === 'Enter') {
            ...
            if (selectedRow) {
                ...
                <tr>
                    <td>
                        <input type="text" class="input-field" name="FisHaraketleriModel[${newRowNumber}].kpsft_StokKod" value="${stokkod}" readonly style="background-color: #dadada; box-sizing: border-box; width: 93%; border: none;">
                    </td>
                    <td>
                        <input type="text" class="input-field" name="FisHaraketleriModel[${newRowNumber}].kpsft_stokAdi" value="${stokad}" readonly style="background-color: #dadada; box-sizing: border-box; width: 100%; border: none;">
                    </td>
                    <td>
                        <input type="text" class="input-field" name="FisHaraketleriModel[${newRowNumber}].StokKartı.birimModel.kpsft_birimKodu" value="${birim}" readonly style="background-color: #dadada; box-sizing: border-box; width: 100%; border: none;">
                    </td>
                    <td>
                        <input type="number" class="input-field" name="FisHaraketleriModel[${newRowNumber}].kpsft_Miktar" value="${miktar}" readonly style="box-sizing: border-box; width: 100%; border: none;">
                    </td>
                    <td>
                        <i style="margin-left:38%" class="fa-solid fa-trash deleteRow"></i>
                    </td>
